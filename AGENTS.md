...
dbt models for LDIF data transformation. Thin driver over `flext-meltano` dbt runner
(ADR-006).
...
- Model generation emits typed `m.DbtLdif.DbtModel` instances for staging and analytics
  artifacts (no dict roundtrip).
