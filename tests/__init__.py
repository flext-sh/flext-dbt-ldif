...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    "TestAnalytics": ("tests.unit", "TestAnalytics"),
    "TestDbtModel": ("tests.unit", "TestDbtModel"),
    "TestFlextDbtLdifCliService": ("tests.unit", "TestFlextDbtLdifCliService"),
    "TestFlextDbtLdifClient": ("tests.unit", "TestFlextDbtLdifClient"),
    "TestFlextDbtLdifUnifiedService": ("tests.unit", "TestFlextDbtLdifUnifiedService"),
    "TestMainEntryPoint": ("tests.unit", "TestMainEntryPoint"),
    "TestModelGenerator": ("tests.unit", "TestModelGenerator"),
    ...
    "test_api_generate_ldif_models": ("tests.unit", "test_api_generate_ldif_models"),
    "test_api_imports": ("tests.unit", "test_api_imports"),
    "test_api_process_ldif_file": ("tests.unit", "test_api_process_ldif_file"),
    "test_api_validate_ldif_quality": ("tests.unit", "test_api_validate_ldif_quality"),
    ...
    "test_run_complete_workflow_all": ("tests.unit", "test_run_complete_workflow_all"),
    "test_run_data_quality_assessment": (
        "tests.unit",
        "test_run_data_quality_assessment",
    ),
    "test_version_is_string": ("tests.unit", "test_version_is_string"),
