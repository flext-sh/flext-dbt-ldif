...
class TestsFlextDbtLdifServicesAndApi:
    """Behavior contract for service workflows + FlextDbtLdif API delegation."""
    ...
    def test_parse_and_validate_ldif_ok(
        ...
        monkeypatch.setattr(service.client, "parse_ldif_file", _parse_ldif_file)
        monkeypatch.setattr(service.client, "validate_ldif_data", _validate_ldif_data)
