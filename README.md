...
FLEXT dbt LDAP - dbt Models for LDIF Data Transformation

## Module Map

- Primary facades: `FlextDbtLdif`, `FlextDbtLdifConstants`, `FlextDbtLdifServiceBase`, `FlextDbtLdifModels`, `FlextDbtLdifUtilities`, `FlextDbtLdifCliService` (+7 more)
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-dbt-ldif` self).
...
- Public extensions exposed by this project: `FlextDbtLdif`, `FlextDbtLdifConstants`, `FlextDbtLdifServiceBase`, `FlextDbtLdifModels`, `FlextDbtLdifUtilities`, `FlextDbtLdifCliService` (+7 more).
